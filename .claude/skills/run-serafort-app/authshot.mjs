...
await emailInput.fill(EMAIL); await page.waitForTimeout(1500) // SSO discovery re-renders the form
...
for (const route of routes) {
  ...
  await page.waitForTimeout(3500) // shell hydration veil lasts ~2.5s
  await page.waitForSelector('h1', { timeout: 15000 }).catch(() => {}) // lazy route chunks compile on first hit
