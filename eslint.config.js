...
const restrictedLayers = [
  {
    ...
    message: "@cap/app can only depend on layers below it",
  },
  {
    group: Layers.LAYER_5,
    message: "Modules cannot depend on @cap/app (layer 6)",
  },
  {
    group: Layers.LAYER_4,
    message: "Layout cannot depend on modules (layer 5+) or @cap/app (layer 6)",
  },
  {
    group: Layers.LAYER_3,
    message:
      "Platform-core cannot depend on layout (layer 4+), modules (layer 5), or @cap/app (layer 6)",
  },
  {
    group: Layers.LAYER_2,
    message:
      "Platform primitives cannot depend on platform-core (layer 3+), layout, modules, or @cap/app",
  },
  {
    group: Layers.LAYER_1,
    message: "Layer 1 packages cannot depend on platform primitives (layer 2+)",
  },
  {
    group: Layers.FOUNDATION,
    message:
      "Foundation packages cannot depend on any other workspace packages",
  },
];
          ...
          patterns: [
            {
              ...
              message:
                "Foundation packages (@cap/shared-types, @cap/api-contracts) cannot depend on other workspace packages",
            },
          ],
        },
      ],
          ...
          patterns: [
            {
              ...
              message:
                "Layer 1 packages cannot depend on platform primitives or higher layers",
            },
          ],
        },
      ],
          ...
          patterns: [
            {
              ...
              message:
                "Layer 2 packages cannot depend on platform-core, layout, modules, or app",
            },
          ],
        },
      ],
          ...
          patterns: [
            {
              ...
              message:
                "@idaas packages cannot depend on platform packages or app",
            },
          ],
        },
      ],
