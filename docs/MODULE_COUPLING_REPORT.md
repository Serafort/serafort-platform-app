...
- Generated: 2026-08-12T04:49:57.114Z
- Source files analyzed: 897
...
| --- | ---: | ---: | ---: | ---: | --- | --- |
| @cap/platform-core | 62 | 4 | 8 | 0.33 | @cap/shared-types (30), @cap/platform-store (21), @cap/theme (13) | @cap/module-auth (99), @cap/layout (22), @cap/app (12) |
| @cap/shared-types | 16 | 0 | 12 | 0.00 | None | @cap/layout (37), @cap/platform-core (30), @cap/theme (25) |
| @cap/platform-store | 29 | 3 | 8 | 0.27 | @cap/shared-types (12), @cap/api-contracts (4), @cap/theme (1) | @cap/layout (31), @cap/platform-core (21), @cap/theme (6) |
| @cap/theme | 197 | 3 | 8 | 0.27 | @cap/shared-types (25), @cap/platform-store (6), @cap/platform-core (4) | @cap/layout (69), @cap/module-auth (19), @cap/module-theme (14) |
...
| @cap/module-auth | 328 | 6 | 3 | 0.67 | @cap/platform-core (99), @cap/layout (19), @cap/theme (19) | @cap/layout (2), @cap/module-dashboard (1), @cap/module-theme (1) |
...
| --- | --- | ---: | ---: | ---: | --- | --- |
| @cap/platform-core | (root) | 2 | 14 | 36 | @cap/platform-core:hooks (7), @cap/platform-core:contexts (4), @cap/platform-core:registry (3) | @cap/module-auth:modules/authentication-core (37), @cap/module-auth:modules/user-directory (17), @cap/module-auth:modules/platform-cluster (15) |
...
| @cap/module-auth | modules/authentication-core | 84 | 12 | 9 | @cap/platform-core:(root) (37), @cap/module-auth:routes (18), @cap/module-auth:domain-kernel (4) | @cap/module-auth:modules/user-directory (23), @cap/module-auth:modules/platform-cluster (14), @cap/module-auth:modules/identity-broker (10) |
...
| @cap/theme | components | 66 | 7 | 2 | @cap/shared-types:(root) (7), @cap/platform-store:(root) (6), @cap/theme:store (6) | @cap/theme:services (2), @cap/theme:(root) (1) |
...
| @cap/platform-core | hooks | 8 | 7 | 1 | @cap/platform-store:(root) (5), @cap/shared-types:(root) (3), @cap/platform-core:types (2) | @cap/platform-core:(root) (7) |
...
| --- | --- | --- | ---: | ---: | ---: | ---: |
| packages/platform-core/src/index.ts | @cap/platform-core | (root) | 24 | 128 | 3 | 128 |
...
| packages/authorization/src/index.ts | @cap/authorization | (root) | 11 | 5 | 0 | 5 |
...
- Most referenced external imports: @mui/material (159), react (149), react-i18next (133), @mui/icons-material (110), react-router-dom (94)
...
- `modules/authentication-core`: 84 files, outgoing to 12 sub-modules, incoming from 9; strongest outgoing @cap/platform-core:(root) (37), @cap/module-auth:routes (18).
...
- `components`: 66 files, outgoing to 7 sub-modules, incoming from 2; strongest outgoing @cap/shared-types:(root) (7), @cap/platform-store:(root) (6).
...
- Most referenced external imports: react (74), @emotion/styled (42), @mui/material/styles (36), classnames (25), react-i18next (20)
...
- Most referenced external imports: react (19), @tanstack/react-query (3), @mui/material (2), react-router-dom (2), @mui/icons-material (1)
- `(root)`: 2 files, outgoing to 14 sub-modules, incoming from 36; strongest outgoing @cap/platform-core:hooks (7), @cap/platform-core:contexts (4).
- `types`: 10 files, outgoing to 4 sub-modules, incoming from 5; strongest outgoing @cap/shared-types:(root) (10), @cap/theme:(root) (3).
- `hooks`: 8 files, outgoing to 7 sub-modules, incoming from 1; strongest outgoing @cap/platform-store:(root) (5), @cap/shared-types:(root) (3).
- `contexts`: 2 files, outgoing to 5 sub-modules, incoming from 2; strongest outgoing @cap/platform-core:types (2), @cap/theme:(root) (2).
...
- Most referenced external imports: zustand (11), react (2), idb (1), zustand/middleware (1), zustand/middleware/immer (1)
...
- `services`: 14 files, outgoing to 3 sub-modules, incoming from 2; strongest outgoing @cap/api-contracts:(root) (4), @cap/platform-store:store (2).
...
- Strongest package dependents: None
- Most referenced external imports: react (7), @mui/material (6), react-i18next (4), @mui/icons-material (3), @dnd-kit/core (1)
