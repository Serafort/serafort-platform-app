...
import { Box, Typography, CircularProgress, Button, Avatar, alpha, useTheme } from '@mui/material'
      ...
      <Box sx={{ display: 'flex', justifyContent: 'center', mb: 3 }}>
        <Avatar
          ...
          sx={{
            ...
            borderColor: alpha(
              status === 'success' ? theme.palette.success.main : theme.palette.error.main,
              0.2,
            ),
          }}
        >
