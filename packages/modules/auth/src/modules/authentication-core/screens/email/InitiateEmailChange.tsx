      ...
      <AnimatePresence mode='wait'>
        {!isSubmitted ? (
            ...
            <form onSubmit={handleSubmit}>
              <Stack spacing={3}>
                ...
                <Button
                  ...
                  endIcon={
                    isPending ? <CircularProgress size={20} color='inherit' /> : <ArrowForward />
                  }
                  sx={{
                    py: 1.5,
                    mt: 1,
                ...
                >
                  {isPending
                    ...
                    : t('email.updateButton', 'Update Email')}
                </Button>
                <Button
                  variant='text'
                  onClick={() => navigate(-1)}
          ...
          >
            ...
            >
              {t(
                'email.confirmCurrentDescription',
                'A verification link has been sent to your inbox. Please follow the instructions to complete your email change.',
              )}
            </Typography>
            <Box
              sx={{
            ...
            >
              ...
              <Box>
                <Typography variant='subtitle1' sx={{ fontWeight: 800 }}>
                  {t('email.checkInbox', 'Check your inbox')}
                </Typography>
                <Typography variant='body2' color='text.secondary'>
                  {t('email.authorizationRequiredV2', 'Click the confirmation link in your email.')}
                </Typography>
              </Box>
            </Box>
            <Button
