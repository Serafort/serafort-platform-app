  ...
  return (
    <Box sx={{ p: 4, maxWidth: 900, mx: 'auto' }}>
      ...
      <Alert severity='info' sx={{ mb: 4, borderRadius: 3 }}>
        Exports include profile information, security history, and application preferences. To
        protect privacy, download links expire after 7 days.
      </Alert>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <Box>
              ...
              <Typography variant='body2' color='text.secondary'>
                Generate a comprehensive archive of all user data.
              </Typography>
            </Box>
            <Button
              variant='contained'
            ...
            >
              ...
              >
                <Typography variant='caption' sx={{ fontWeight: 800 }}>
                  Exporting User Portability Chunk {tracker.processedChunks} of{' '}
                  {tracker.totalChunks}
                </Typography>
                <Chip
