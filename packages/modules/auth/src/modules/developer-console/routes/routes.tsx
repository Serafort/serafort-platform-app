...
export const developerConsoleRouteConfig: AuthRouteConfig[] = [
  ...
  createAuthRoute(Path.developerConsole, <DeveloperApiKeysScreen />, { requiresVerification: true, layout: 'admin' }),
  createAuthRoute(Path.webhooks, <WebhooksScreen />, { requiresVerification: true, layout: 'admin' }),
