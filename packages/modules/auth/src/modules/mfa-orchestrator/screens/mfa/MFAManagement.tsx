...
export default function MFAManagement() {
    ...
    async (regenerate = false) => {
      try {
        ...
        if (regenerate) {
          ...
          setSuccessMsg(
            t('mfa.backupRegenerated', 'New backup recovery codes generated successfully.'),
          )
        } else {
    ...
    (regenerate = false) => {
      stepUp.requireStepUp(() => executeOpenCodesModal(regenerate), {
        actionName: regenerate
          ? t('mfa.regenerateCodes', 'Regenerate Backup Codes')
          : t('mfa.viewCodes', 'View Backup Codes'),
        actionDescription: t(
          'mfa.stepUpCodesDesc',
          'Step-up authentication is required to access your plaintext recovery codes.',
        ),
        icon: 'key',
      })
    },
  ...
  const handlePromptDisableMfa = useCallback(() => {
    stepUp.requireStepUp(() => setDisableModalOpen(true), {
      ...
      actionDescription: t(
        ...
        'Please verify your identity before disabling security protection.',
      ),
      icon: 'delete',
    })
  }, [stepUp, t])
  ...
  const handleSavePolicy = () => {
    ...
    setSuccessMsg(
      t('mfa.policySaved', 'MFA sign-in and step-up frequency policy updated successfully.'),
    )
  }
    ...
    <Box sx={{ width: '100%', maxWidth: 1200, mx: 'auto', p: { xs: 2, md: 4 } }}>
          ...
          <Box>
            ...
            <Typography variant='body2' color='text.secondary'>
              {t(
                ...
                'Manage enterprise authentication factors, hardware keys, step-up rules, and access policies.',
              )}
            </Typography>
          </Box>
        </Box>
      ...
      >
        ...
        >
          ...
          >
            {isAnyMfaActive ? (
              <Check sx={{ fontSize: 26, strokeWidth: 1.5 }} />
            ) : (
              <WarningAmber sx={{ fontSize: 26 }} />
            )}
          </Avatar>
          <Box sx={{ flex: 1 }}>
            ...
            <Typography variant='body2' sx={{ opacity: 0.92, fontSize: '0.875rem' }}>
              {isAnyMfaActive
                ? t(
                    ...
                    'A verification code, SMS, or passkey is required whenever you sign in.',
                  )
                : t(
                    'mfa.statusUnprotectedDesc',
                    'Enable an authenticator app, biometric key, or SMS to safeguard your account against unauthorized access.',
                  )}
            </Typography>
          </Box>
          {!isAnyMfaActive && (
                  ...
                  >
                    ...
                    <Box sx={{ mb: 2 }}>
                      <Stack direction='row' spacing={1.5} alignItems='center' sx={{ mb: 1.5 }}>
                        ...
                        <Typography
                          variant='body2'
                          sx={{ fontWeight: 700, color: 'text.primary', pr: 2 }}
                        >
                    ...
                    <Box>
                      <Chip
                        label={
                          passkeyCount > 0
                            ? `${passkeyCount} ${t('mfa.enrolled', 'Enrolled')}`
                            : t('mfa.unconfigured', 'Not Configured')
                        }
                      ...
                      >
                        {passkeyCount > 0
                          ? t('mfa.lastUsedPasskey', 'Last used recently on macOS')
                          : t('mfa.noPasskeysRegistered', 'No keys enrolled')}
                      </Typography>
                      <Button
                        fullWidth
                        variant='outlined'
                ...
                <Grid size={{ xs: 12, sm: 6 }}>
                  ...
                  >
                    ...
                    <Box>
                      ...
                      >
                        {isPasskeyEnabled
                          ? t('mfa.lastUsedBiometric', 'Last used 1d ago on Windows')
                          : t('mfa.supportedOnPlatform', 'Supported on this device')}
                      </Typography>
                      <Button
                        fullWidth
                        variant='outlined'
                      ...
                      >
                        {isPasskeyEnabled
                          ...
                          : t('mfa.enableSensor', 'Enable Sensor')}
                      </Button>
                    </Box>
                  </Card>
                </Grid>
                ...
                <Grid size={{ xs: 12, sm: 6 }}>
                  ...
                  >
                    ...
                    <Box>
                      ...
                      >
                        {isTotpEnabled
                          ? t('mfa.lastUsedTotp', 'Last used 4d ago on Android')
                          : t('mfa.notSetup', 'Not configured')}
                      </Typography>
                      {isTotpEnabled ? (
                        <Button
                          fullWidth
                  ...
                  >
                    ...
                    <Box>
                      <Chip
                        label={
                          isSmsEnabled
                            ? t('mfa.enabledPrimary', 'Enabled (Backup)')
                            : t('common.disabled', 'Disabled')
                        }
                      ...
                      >
                        {isSmsEnabled
                          ? t('mfa.lastUsedSms', 'Last used 2w ago on Web')
                          : t('mfa.noPhoneEnrolled', 'No phone configured')}
                      </Typography>
                      <Button
                        fullWidth
                        variant='outlined'
            ...
            <Stack direction='row' spacing={2} alignItems='center'>
              ...
              <Box>
                ...
                <Typography variant='caption' color='text.secondary'>
                  {t(
                    'mfa.backupDesc',
                    'Single-use emergency codes to sign in if you lose access to your primary factors.',
                  )}
                </Typography>
              </Box>
            </Stack>
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2.5 }}>
            ...
            <Box>
              ...
              >
                {t(
                  'mfa.challengeFrequencyDesc',
                  'Determine how frequently users must re-authenticate with a secondary factor.',
                )}
              </Typography>
              <FormControl size='small' sx={{ minWidth: 280 }}>
                ...
                >
                  <MenuItem value='30d'>
                    {t('mfa.policy30d', 'Every 30 days on trusted devices')}
                  </MenuItem>
                  <MenuItem value='7d'>
                    {t('mfa.policy7d', 'Every 7 days on trusted devices')}
                  </MenuItem>
      ...
      >
        <DialogTitle
          sx={{ fontWeight: 800, pb: 1, display: 'flex', alignItems: 'center', gap: 1.5 }}
        >
          <Tune color='primary' />
        ...
        <DialogContent>
          ...
          <Stack spacing={2.5}>
            <Box sx={{ p: 2, borderRadius: 2, border: '1px solid', borderColor: 'divider' }}>
              ...
              >
                {t(
                  'mfa.trustedDeviceDesc',
                  'How often a full 2FA challenge is prompted when accessing from a recognized browser.',
                )}
              </Typography>
              <FormControl fullWidth size='small'>
                ...
                >
                  <MenuItem value='30d'>
                    {t('mfa.policy30d', 'Every 30 days on trusted devices (Recommended)')}
                  </MenuItem>
                  <MenuItem value='7d'>
                    {t('mfa.policy7d', 'Every 7 days on trusted devices')}
                  </MenuItem>
                  <MenuItem value='always'>
                    {t('mfa.policyAlways', 'Every sign-in (High Security / Zero Trust)')}
                  </MenuItem>
                </Select>
              </FormControl>
            </Box>
            ...
            >
              <Box sx={{ pr: 2 }}>
                ...
                <Typography variant='caption' color='text.secondary'>
                  {t(
                    'mfa.enforceStepUpDesc',
                    'Require secondary biometric or TOTP authentication when viewing recovery codes, modifying keys, or disabling 2FA.',
                  )}
                </Typography>
              </Box>
              <Switch
