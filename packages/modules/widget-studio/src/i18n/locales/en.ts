export const widgetStudioEn = {
  widgetStudio: {
    ...
    errors: {
      noApiKey:
        "AI Widget Studio service is not available. Please contact your administrator.",
      injectionDetected:
        "Your prompt contains patterns that cannot be processed for security reasons.",
    },
  },
};
