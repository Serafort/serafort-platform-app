...
export const DEFAULT_POLICY_SET: PolicySet = {
  ...
  policies: [
    ...
    },
    {
      ...
      description:
        "Enforce minimum role ranks and allowed roles on administrative routes",
      rules: [
        {
          effect: PolicyEffectEnum.DENY,
    ...
    // -----------------------------------------------------------------
    {
      ...
      description:
        "Platform Owners and Super Admins have full access across infrastructure and all tenants",
      rules: [
        {
    ...
    },
    {
      ...
      description:
        "Platform Support has cross-tenant diagnostics, telemetry, logs, and audit-governed impersonation",
      rules: [
    ...
    },
    {
      ...
      description:
        "Platform Billing Admins manage gateways, license keys, subscriptions, and MRR metrics",
      rules: [
        {
          effect: PolicyEffectEnum.ALLOW,
    ...
    // -----------------------------------------------------------------
    {
      ...
      description:
        "Tenant Owners hold full ownership of their tenant workspace, white-labeling, and billing",
      rules: [
    ...
    },
    {
      ...
      description:
        "Tenant Admins manage team members, invites, auto-join rules, and theme presets",
      rules: [
        {
          effect: PolicyEffectEnum.ALLOW,
          roles: [
    ...
    },
    {
      ...
      description:
        "Security Admins manage SSO/SCIM, Visual ABAC policy canvas, passkeys, and MFA enforcement",
      rules: [
        {
          effect: PolicyEffectEnum.ALLOW,
    ...
    },
    {
      ...
      description:
        "Developers generate API keys, webhooks, inspect OIDC/SCIM sandbox tokens, and manage plugins",
      rules: [
        {
          effect: PolicyEffectEnum.ALLOW,
    ...
    },
    {
      ...
      description:
        "Standard Members collaborate and manage resources inside their tenant boundary",
      rules: [
        {
          effect: PolicyEffectEnum.ALLOW,
          roles: [
    ...
    },
    {
      ...
      description:
        "Viewers and Auditors have strictly read-only access across tenant resources",
      rules: [
        {
          effect: PolicyEffectEnum.ALLOW,
