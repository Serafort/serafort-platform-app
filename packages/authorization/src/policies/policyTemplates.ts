...
export const POLICY_CANVAS_TEMPLATES: VisualPolicyGraph[] = [
  {
    ...
    description: 'Enforces strict tenant boundary isolation ensuring users can only interact with resources belonging to their organization.',
    version: '1.0.0',
    defaultEffect: 'deny',
    ...
    edges: [
      { id: 'e-1', source: 'sub-tenant-member', target: 'act-all-ops', animated: true },
      { id: 'e-2', source: 'act-all-ops', target: 'res-org-entities', animated: true },
      { id: 'e-3', source: 'res-org-entities', target: 'cond-same-tenant', animated: true },
      { id: 'e-4', source: 'cond-same-tenant', target: 'dec-allow-isolated', animated: true },
    ],
  },
  {
    id: 'template-step-up-mfa-exports',
    name: 'Step-Up MFA on Financial Exports',
    description: 'Requires multi-factor authentication verification before allowing export of sensitive invoice and financial data.',
    version: '1.0.0',
    defaultEffect: 'deny',
    combiningAlgorithm: 'deny-overrides',
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          effect: 'deny',
          reason: 'Sensitive export requires elevated Step-Up MFA authentication',
          priority: 50,
    ...
    edges: [
      ...
      { id: 'e-6', source: 'act-export-unverified', target: 'res-financials-unverified' },
      { id: 'e-7', source: 'res-financials-unverified', target: 'dec-deny-step-up' },
    ],
  },
  {
    id: 'template-owner-only-document-deletion',
    name: 'Owner-Only Resource Deletion',
    description: 'Allows resource authors or administrators to delete documents, while strictly blocking non-owners.',
    version: '1.0.0',
    defaultEffect: 'deny',
    combiningAlgorithm: 'deny-overrides',
    nodes: [
