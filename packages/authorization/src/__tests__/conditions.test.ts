...
describe('ABAC Conditions', () => {
  ...
  it('evaluates built-in owns condition correctly', () => {
    ...
    const ownResource: PolicyResource = { type: 'item', attributes: { ownerId: 42 } }
    const notOwnResource: PolicyResource = { type: 'item', attributes: { ownerId: 99 } }
  ...
  it('evaluates built-in sameOrg condition correctly', () => {
    ...
    const sameOrgResource: PolicyResource = { type: 'item', attributes: { orgId: 100 } }
    const diffOrgResource: PolicyResource = { type: 'item', attributes: { orgId: 200 } }
