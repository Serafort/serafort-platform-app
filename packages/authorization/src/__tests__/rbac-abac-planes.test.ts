    ...
    it("activates support impersonation and enforces read-only / safety guards", () => {
      ...
      const deleteDecision = engine.evaluate({
        ...
        resource: {
          ...
          attributes: { orgId: "org-customer-123" },
        },
        action: "delete",
      });
