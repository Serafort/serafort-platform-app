...
export const SubjectNodeComponent = memo(
  ({ data, selected }: NodeProps<SubjectNode>) => {
    const theme = useTheme();
    const roles = data.roles || ["*"];
    const permissions = data.permissions || [];
    const isPlatformPlane =
      data.plane === "platform" || roles.some((r) => isPlatformRole(r));
      ...
      >
        ...
        <Handle
          ...
          style={{
            width: 10,
            height: 10,
            backgroundColor: isPlatformPlane
              ? theme.palette.secondary.main
              : theme.palette.primary.main,
