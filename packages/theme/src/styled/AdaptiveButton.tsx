    ...
    switch (variant) {
        ...
        return {
          ...
          boxShadow:
            (typeof theme.customShadows?.primary === "object"
              ? theme.customShadows?.primary?.sm
              : theme.customShadows?.primary) || theme.shadows[2],
          "&:hover:not(:disabled)": {
            background:
      ...
      case "secondary":
        return {
          ...
          border: "none",
          boxShadow:
            (typeof theme.customShadows?.secondary === "object"
              ? theme.customShadows?.secondary?.sm
              : theme.customShadows?.secondary) || theme.shadows[2],
          "&:hover:not(:disabled)": {
            background:
              theme.palette.secondary.dark ||
              darken(theme.palette.secondary.main, 0.12),
            transform: "translateY(-1px)",
          },
        };
      case "outline":
