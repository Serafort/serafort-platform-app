...
const StyledLiquidGlassCard = styled('div')<Omit<LiquidGlassCardProps, 'children'>>(
  ({
    theme,
    blur,
    background,
    ...
    return {
      ...
      '&:hover': {
        ...
        borderColor: isLight ? 'rgba(255, 255, 255, 0.8)' : 'rgba(255, 255, 255, 0.25)',
      },
    };
  },
);
...
export const LiquidGlassCard: React.FC<LiquidGlassCardProps> = ({
  ...
  return (
    <StyledLiquidGlassCard {...props}>
      {children}
    </StyledLiquidGlassCard>
  );
};
