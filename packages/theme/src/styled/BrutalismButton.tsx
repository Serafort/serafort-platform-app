...
const StyledBrutalismButton = styled("button")<
  Omit<BrutalismButtonProps, "children">
>(({
  theme,
  borderWidth,
  borderColor,
  ...
  const resolvedOffset =
    shadowOffset || theme.tenantTheme?.effects.brutalism?.shadowOffset || "4px";
  const resolvedColor =
    shadowColor ||
    theme.tenantTheme?.effects.brutalism?.shadowColor ||
    "#000000";
  ...
  return {
    border: `${borderWidth || theme.tenantTheme?.effects.brutalism?.borderWidth || "2px"} solid ${
      borderColor ||
      theme.tenantTheme?.effects.brutalism?.borderColor ||
      "#000000"
    }`,
...
export const BrutalismButton: React.FC<BrutalismButtonProps> = ({
  children,
  ...props
}) => {
