...
export const AdaptiveCard: React.FC<AdaptiveCardProps> = ({
  ...
  switch (activeStyle) {
    case "glass":
      return (
        <GlassCard
          padding={padding || glassConfig?.padding}
          {...glassConfig}
          className={className}
          style={style}
        >
    ...
    case "neu":
      return (
        <NeuCard
          padding={padding || neuConfig?.padding}
          {...neuConfig}
          className={className}
          style={style}
        >
    ...
    case "brutalism":
      return (
        <BrutalismCard
          padding={padding || brutalismConfig?.padding}
          {...brutalismConfig}
          className={className}
          style={style}
        >
    ...
    case "bento":
      return (
        <BentoCard
          padding={padding || bentoConfig?.padding}
          {...bentoConfig}
          className={className}
          style={style}
        >
    ...
    case "organic":
      return (
        <OrganicCard
          padding={padding || organicConfig?.padding}
          {...organicConfig}
          className={className}
          style={style}
        >
    ...
    case "immersive":
      return (
        <ImmersiveCard
          padding={padding || immersiveConfig?.padding}
          {...immersiveConfig}
          className={className}
          style={style}
        >
