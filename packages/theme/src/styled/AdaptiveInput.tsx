...
const Label = styled("label")(({ theme }) => ({
  display: "block",
  fontSize:
    getComponentCustomValue(theme, "input", "labelFontSize") ||
    theme.typography.body2.fontSize,
  fontWeight:
    getComponentCustomValue(theme, "input", "labelFontWeight") ||
    theme.typography.fontWeightMedium,
  color: theme.palette.text.primary,
  marginBottom:
    getComponentCustomValue(theme, "input", "labelMarginBottom") ||
    theme.spacing(1),
}));
...
const HelperText = styled("span")(({ theme }) => ({
  display: "block",
  fontSize:
    getComponentCustomValue(theme, "input", "helperFontSize") ||
    theme.typography.caption.fontSize,
  color: getThemeTextMuted(theme),
  marginTop:
    getComponentCustomValue(theme, "input", "helperMarginTop") ||
    theme.spacing(0.5),
}));
...
const ErrorText = styled("span")(({ theme }) => ({
  display: "block",
  fontSize:
    getComponentCustomValue(theme, "input", "errorFontSize") ||
    theme.typography.caption.fontSize,
  color: theme.palette.error.main,
  marginTop:
    getComponentCustomValue(theme, "input", "errorMarginTop") ||
    theme.spacing(0.5),
}));
...
export const AdaptiveInput: React.FC<AdaptiveInputProps> = ({
  ...
  const renderInput = (
    InputComponent: typeof StandardInput,
    inputStyle?: React.CSSProperties,
  ) => <InputComponent className={className} style={inputStyle} {...props} />;
