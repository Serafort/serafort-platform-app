...
export const effectPresetTokens = {
  ...
  liquidGlass: {
    ...
    shadow: 'inset 0 1px 1px 0 rgba(255, 255, 255, 0.4), 0 12px 36px 0 rgba(0, 0, 0, 0.35)',
  },
  neu: {
...
export const getSemanticColors = (mode: 'light' | 'dark'): SemanticColors => ({
  ...
  textPrimary: mode === 'dark' ? primitiveColors.slate[50] : primitiveColors.slate[900],
  textSecondary: mode === 'dark' ? primitiveColors.slate[400] : primitiveColors.slate[600],
  textTertiary: mode === 'dark' ? primitiveColors.slate[500] : primitiveColors.slate[400],
});
