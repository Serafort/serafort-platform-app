...
describe('createBaseMuiTheme', () => {
  describe('basic theme creation', () => {
    it('should create a light theme options object', () => {
      const theme = createBaseMuiTheme(defaultSettings, 'light' as SystemMode, 'ltr' as Direction)
    ...
    it('should create a dark theme options object', () => {
      const theme = createBaseMuiTheme(defaultSettings, 'dark' as SystemMode, 'ltr' as Direction)
    ...
    it('should set RTL direction', () => {
      const theme = createBaseMuiTheme(defaultSettings, 'light' as SystemMode, 'rtl' as Direction)
