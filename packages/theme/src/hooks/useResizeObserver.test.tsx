...
describe("useResizeObserver", () => {
  ...
  it('derives "lg" containerSize for width >= 1024', () => {
    ...
    act(() => {
      triggerResize([
        { target: dummyElement, contentRect: { width: 1100, height: 600 } },
      ]);
    });
  ...
  it("supports debounced updates", () => {
    ...
    act(() => {
      triggerResize([
        { target: dummyElement, contentRect: { width: 500, height: 400 } },
      ]);
    });
  ...
  it("calls onResize callback without triggering state update", () => {
    ...
    act(() => {
      triggerResize([
        { target: dummyElement, contentRect: { width: 900, height: 500 } },
      ]);
    });
  ...
  it("applies custom breakpoints to derive containerSize", () => {
    ...
    act(() => {
      triggerResize([
        { target: dummyElement, contentRect: { width: 450, height: 0 } },
      ]);
    });
