    ...
    <MuiGlobalStyles
      styles={(theme: Theme) => ({
        ...
        ".action-lock-transition": {
          transition:
            "all var(--motion-duration-quick, 120ms) var(--motion-easing-standard, cubic-bezier(0.4, 0.0, 0.2, 1)) !important",
        },
        ".action-lock-active": {
        ...
        ".state-empty-container": {
          ...
          border:
            "var(--state-empty-dashed-border, 1px dashed var(--surface-border))",
