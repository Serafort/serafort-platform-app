...
export const ROLE_DEFINITIONS: Record<string, RoleDefinition> = {
  ...
  platform_owner: {
    ...
    rank: 100,
    description:
      "Full global access to platform infrastructure, all tenants, billing models, and marketplace extensions",
  ...
  platform_support: {
    ...
    rank: 75,
    description:
      "Cross-tenant diagnostics, telemetry, error streams, and secure time-bound impersonation with mandatory audit logs",
    defaultPermissions: [
  ...
  platform_billing: {
    ...
    rank: 70,
    description:
      "Manage Stripe/billing gateways, commercial tiers, license keys, and financial analytics",
    defaultPermissions: [
  ...
  tenant_owner: {
    ...
    rank: 60,
    description:
      "Primary contact with complete ownership of tenant workspace, billing, white-label domains, and danger zone actions",
    defaultPermissions: [
      // Org management — full
      "org:members:invite",
      "org:members:read",
  ...
  tenant_admin: {
    ...
    rank: 50,
    description:
      "Team invites, member lifecycle, role assignment, auto-join rules, and theme presets",
    defaultPermissions: [
      "org:members:invite",
      "org:members:read",
      "org:members:update",
  ...
  security_admin: {
    ...
    rank: 45,
    description:
      "Configures SSO/SAML/OIDC, SCIM 2.0, Visual ABAC policy canvas, passkeys, adaptive MFA, and audit anomaly streams",
    defaultPermissions: [
      // SSO & Auth
      "auth:sso:configure",
      "auth:sso:read",
  ...
  developer: {
    ...
    rank: 40,
    description:
      "Manages tenant API keys, Webhooks, OIDC/SCIM sandbox testing, and Auth Plugin Marketplace integrations",
    defaultPermissions: [
      "dev:api_keys:create",
      "dev:api_keys:read",
      "dev:api_keys:revoke",
  ...
  member: {
    ...
    rank: 20,
    description:
      "Standard day-to-day access to create, edit, and collaborate on tenant resources",
    defaultPermissions: [
      "content:resource:create",
      "content:resource:read",
      "content:resource:update",
  ...
  participant: {
    ...
    defaultPermissions: ["content:resource:read", "content:submission:create"],
  },
  user: {
    slug: "user",
    name: "Standard User",
    ...
    defaultPermissions: ["content:resource:read"],
  },
  viewer: {
    slug: "viewer",
    name: "Viewer / Auditor",
    ...
    rank: 5,
    description:
      "Read-only access across tenant resources for auditors, observers, and guests",
    defaultPermissions: ["content:resource:read", "security:audit_logs:read"],
  },
};
