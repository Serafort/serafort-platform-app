...
function flattenCatalog(obj: Record<string, unknown>, acc: string[] = []): string[] {
...
export type AtomicPermission =
  ...
  | 'theme:ai:generate' | 'theme:ai:read'
  ...
  // Platform
  | 'platform:tenants:create' | 'platform:tenants:read' | 'platform:tenants:update'
  | 'platform:tenants:suspend' | 'platform:tenants:delete'
  | 'platform:billing:read' | 'platform:billing:write'
  | 'platform:tiers:read' | 'platform:tiers:write'
  | 'platform:flags:read' | 'platform:flags:write'
  | 'platform:marketplace:approve' | 'platform:marketplace:read' | 'platform:marketplace:reject'
  ...
  | 'content:submission:create' | 'content:submission:read' | 'content:submission:grade'
...
export const BUILT_IN_PERMISSION_SETS: readonly PermissionSet[] = Object.freeze([
  {
    ...
    description: 'Configure and manage SAML 2.0 / OIDC identity providers, SCIM provisioning, and IDP connections',
    ownerId: 'platform',
    permissions: [
      'auth:sso:configure', 'auth:sso:read', 'auth:sso:delete',
      'auth:scim:provision', 'auth:scim:read', 'auth:scim:delete',
  ...
  },
  {
    ...
    description: 'Manage multi-factor authentication and passkey / WebAuthn enforcement policies',
    ownerId: 'platform',
    permissions: [
      'auth:mfa:enforce', 'auth:mfa:configure', 'auth:mfa:read',
      'auth:passkey:enforce', 'auth:passkey:configure', 'auth:passkey:read',
  ...
  },
  {
    ...
    name: 'Security Audit',
    description: 'Read-only access to audit logs, anomaly detection, and threat intelligence streams',
    ownerId: 'platform',
    permissions: [
      'security:audit_logs:read', 'security:audit_logs:export',
  ...
  },
  {
    ...
    description: 'Author, edit, and execute policies in the Visual Policy & ABAC Canvas',
    ownerId: 'platform',
    permissions: [
      'security:abac:read', 'security:abac:write', 'security:abac:delete', 'security:abac:execute',
      'security:anomaly:configure', 'security:threats:configure',
    ],
  },
  {
    id: 'preset:theme',
    name: 'Theme & Branding',
    description: 'Manage design tokens, AI theme generation, presets, and organizational branding',
    ownerId: 'platform',
    permissions: [
      'theme:tokens:read', 'theme:tokens:write',
      'theme:ai:generate', 'theme:ai:read',
  ...
  },
  {
    ...
    ownerId: 'platform',
    permissions: [
      'theme:tokens:read', 'theme:ai:read', 'theme:branding:read', 'theme:preset:read',
    ],
  },
  {
    id: 'preset:dev-sandbox',
    name: 'Developer Sandbox',
    description: 'Read API keys, use the interactive OIDC/SCIM sandbox, and read webhooks',
    ownerId: 'platform',
    permissions: [
      'dev:sandbox:execute', 'dev:sandbox:read',
      'dev:api_keys:read',
  ...
  },
  {
    ...
    description: 'Full developer access: API keys, webhooks, sandbox, and plugin management',
    ownerId: 'platform',
    permissions: [
      'dev:api_keys:create', 'dev:api_keys:read', 'dev:api_keys:revoke',
      'dev:webhooks:create', 'dev:webhooks:read', 'dev:webhooks:update', 'dev:webhooks:delete',
  ...
  },
  {
    ...
    description: 'Invite, update, and remove team members; assign roles; manage auto-join domains',
    ownerId: 'platform',
    permissions: [
      'org:members:invite', 'org:members:read', 'org:members:update', 'org:members:remove',
  ...
  },
  {
    ...
    name: 'Billing Viewer',
    description: 'Read-only access to billing information, invoices, and subscription details',
    ownerId: 'platform',
    permissions: [
